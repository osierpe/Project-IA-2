...
public class NeuralController : MonoBehaviour
{
    ...
    private bool endSimulationConditions()
    {
        ...
        return (currentDistance / driveTime <= 0.1 && driveTime > 75) || driveTime > this.maxSimulTime;
    }
	...
	public float GetScore() {
        ...
        float fitness = 0;
        fitness += GoalsOnAdversaryGoal * 100000; //soma 100000 * Golos que o adversario levou;
        fitness -= GoalsOnMyGoal * 100000;        //menos 100000 * golos que eu levei;
        fitness += hitTheBall * 100;
        fitness -= distanceToBall;
